...
public class AddressNotValidProcessorHH implements HHOutcomeServiceProcessor {
  ...
  public void processMessage(HouseholdOutcome householdOutcome) throws GatewayException{
    ...
    gatewayEventManager.triggerEvent(String.valueOf(householdOutcome.getCaseId()), HH_OUTCOME_SENT, "type", "HH_ADDRESS_NOT_VALID_OUTCOME_SENT", "transactionId", householdOutcome.getTransactionId().toString(), "Case Ref", householdOutcome.getCaseReference());
  }
