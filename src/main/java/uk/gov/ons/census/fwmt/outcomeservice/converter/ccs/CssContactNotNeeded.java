...
import static uk.gov.ons.census.fwmt.outcomeservice.config.GatewayEventsConfig.CCSPL_CONTACT_NOT_NEEDED_OUTCOME_SENT;
...
public class CssContactNotNeeded implements CcsOutcomeServiceProcessor {
  ...
  public void processMessage(CCSPropertyListingOutcome ccsPLOutcome) {
    ...
    gatewayEventManager.triggerEvent(String.valueOf(ccsPLOutcome.getPropertyListingCaseId()), CCSPL_CONTACT_NOT_NEEDED_OUTCOME_SENT);
  }
}
