...
public class GatewayEventsConfig {
  ...
  public GatewayEventManager gatewayEventManager() {
    ...
    gatewayEventManager.addEventTypes(new String[] {COMET_HH_OUTCOME_RECEIVED, COMET_CCSSI_OUTCOME_RECEIVED,
        ...
        REDIS_SERVICE_UP, CCSPL_CACHED_OUTCOME, COMET_SPG_OUTCOME_RECEIVED, COMET_SPG_UNITADDRESS_OUTCOME_RECEIVED,
        COMET_SPG_STANDALONE_OUTCOME_RECEIVED, OUTCOME_SENT, NEW_UNIT_ADDRESS_OUTCOME_SENT,
        ...
        ADDRESS_NOT_VALID_OUTCOME_SENT, PROCESSING_SPG_OUTCOME, PREPROCESSING_SPG_STANDALONE_OUTCOME,
        PREPROCESSING_SPG_UNITADDRESS_OUTCOME, PREPROCESSING_CE_OUTCOME,PREPROCESSING_CE_UNITADDRESS_OUTCOME,
        PROCESSING_CE_OUTCOME, PREPROCESSING_CE_STANDALONE_OUTCOME, PREPROCESSING_CE_STANDALONE_OUTCOME,
        COMET_CE_OUTCOME_RECEIVED, COMET_CE_UNITADDRESS_OUTCOME_RECEIVED, COMET_CE_STANDALONE_OUTCOME_RECEIVED,
        UPDATE_RESIDENT_COUNT_OUTCOME_SENT, PROCESSING_OUTCOME,
        RM_FIELD_REPUBLISH
    });
