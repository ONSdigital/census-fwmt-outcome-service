...
public class GatewayEventsConfig {
  ...
  public static final String CESPG_FULFILMENT_REQUESTED_OUTCOME_SENT = "CESPG_FULFILMENT_REQUESTED_OUTCOME_SENT";
  public static final String CESPG_EXTRAORDINARY_REFUSAL_RECEIVED_OUTCOME_SENT = "CESPG_EXTRAORDINARY_REFUSAL_RECEIVED_OUTCOME_SENT";
  public static final String CESPG_HARD_REFUSAL_RECEIVED_OUTCOME_SENT = "CESPG_HARD_REFUSAL_RECEIVED_OUTCOME_SENT";
  public static final String CESPG_QUESTIONNAIRE_LINKED_OUTCOME_SENT = "CESPG_QUESTIONNAIRE_LINKED_OUTCOME_SENT";
  public static final String CESPG_NEW_ADDRESS_REPORTED_OUTCOME_SENT = "CESPG_NEW_ADDRESS_REPORTED_OUTCOME_SENT";
  public static final String CESPG_NEW_UNIT_ADDRESS_OUTCOME_SENT = "CESPG_NEW_UNIT_ADDRESS_OUTCOME_SENT";
  ...
  public GatewayEventManager gatewayEventManager() {
    ...
    gatewayEventManager.addEventTypes(new String[] {COMET_HH_OUTCOME_RECEIVED, COMET_CCSSI_OUTCOME_RECEIVED,
        ...
        COMET_CESPGSTANDALONE_OUTCOME_RECEIVED, CESPG_OUTCOME_SENT, CESPG_NEW_UNIT_ADDRESS_OUTCOME_SENT,
        CESPG_NEW_ADDRESS_REPORTED_OUTCOME_SENT,CESPG_QUESTIONNAIRE_LINKED_OUTCOME_SENT,
        CESPG_HARD_REFUSAL_RECEIVED_OUTCOME_SENT, CESPG_EXTRAORDINARY_REFUSAL_RECEIVED_OUTCOME_SENT,
        CESPG_FULFILMENT_REQUESTED_OUTCOME_SENT, CESPG_ADDRESS_TYPE_CHANGED_OUTCOME_SENT,
        CESPG_ADDRESS_NOT_VALID_OUTCOME_SENT, PROCESSING_CESPG_OUTCOME, PREPROCESSING_CESPGSTANDALONE_OUTCOME,
        PREPROCESSING_CESPGUNITADDRESS_OUTCOME, PREPROCESSING_CESPG_OUTCOME,
    });
