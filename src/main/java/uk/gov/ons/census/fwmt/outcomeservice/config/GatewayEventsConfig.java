...
public class GatewayEventsConfig {
  ...
  public static final String COMET_CESPGUNITADDRESS_OUTCOME_RECEIVED = "COMET_CESPGUNITADDRESS_OUTCOME_RECEIVED";
  public static final String COMET_CESPGSTANDALONE_OUTCOME_RECEIVED = "COMET_CESPGSTANDALONE_OUTCOME_RECEIVED";
