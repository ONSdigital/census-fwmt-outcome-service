...
public class GatewayEventsConfig {
  ...
  public GatewayEventManager gatewayEventManager() {
    ...
    gatewayEventManager.addEventTypes(new String[] {COMET_HH_OUTCOME_RECEIVED, COMET_CCSSI_OUTCOME_RECEIVED,
        ...
        REDIS_SERVICE_UP, CCSPL_CACHED_OUTCOME, COMET_CESPG_OUTCOME_RECEIVED, COMET_SPG_UNITADDRESS_OUTCOME_RECEIVED,
        ...
        COMET_CE_OUTCOME_RECEIVED, UPDATE_RESIDENT_COUNT_OUTCOME_SENT, PROCESSING_OUTCOME,
        RM_FIELD_REPUBLISH
    });
