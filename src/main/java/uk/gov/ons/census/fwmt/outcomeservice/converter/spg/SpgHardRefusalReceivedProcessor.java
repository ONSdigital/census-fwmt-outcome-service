...
import static uk.gov.ons.census.fwmt.outcomeservice.config.GatewayEventsConfig.CESPG_HARD_REFUSAL_RECEIVED_OUTCOME_SENT;
...
public class SpgHardRefusalReceivedProcessor implements SpgOutcomeServiceProcessor {
  ...
  public UUID process(SpgOutcomeSuperSetDto outcome, UUID caseIdHolder) throws GatewayException {
    ...
    gatewayEventManager.triggerEvent(String.valueOf(caseId), CESPG_OUTCOME_SENT,
        "type", CESPG_HARD_REFUSAL_RECEIVED_OUTCOME_SENT,
