...
import static uk.gov.ons.census.fwmt.outcomeservice.config.GatewayEventsConfig.CCSPL_ADDRESS_NOT_VALID_OUTCOME_SENT;
...
public class CssAddressNotValidProcessor implements CcsOutcomeServiceProcessor {
  ...
  public void processMessage(CCSPropertyListingOutcome ccsPLOutcome) {
    ...
    gatewayEventManager.triggerEvent(String.valueOf(ccsPLOutcome.getPropertyListingCaseId()), CCSPL_ADDRESS_NOT_VALID_OUTCOME_SENT);
  }
