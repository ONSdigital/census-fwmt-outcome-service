...
public class SpgRefusalReceivedProcessor implements SpgOutcomeServiceProcessor {
  ...
  @Override
  public boolean isValid(SPGOutcome spgOutcome) {
    List<String> validSecondaryOutcomes = Arrays.asList("Phone - Hard Refusal", "Phone - Extraordinary Refusal");
    return validSecondaryOutcomes.contains(spgOutcome.getSecondaryOutcomeDescription());
  }
