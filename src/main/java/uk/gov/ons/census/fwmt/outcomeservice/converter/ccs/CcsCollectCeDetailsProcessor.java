...
public class CcsCollectCeDetailsProcessor implements CcsOutcomeServiceProcessor {
  ...
  public void processMessage(CCSPropertyListingOutcome ccsPLOutcome) throws GatewayException {
    ...
    gatewayEventManager.triggerEvent(String.valueOf(ccsPLOutcome.getPropertyListingCaseId()), CCSPL_OUTCOME_SENT, "type", "CCSPL_COLLECT_CE_DETAILS_OUTCOME_SENT", "transactionId", ccsPLOutcome.getTransactionId().toString());
  }
}
